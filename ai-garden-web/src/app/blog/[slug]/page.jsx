...
function SidebarCard({ title, children }) {
  return (
    <div className="rounded-2xl border border-[#34B23D] bg-gradient-to-t from-[#164C1A]/15 to-[#34B23D]/15 p-5">
      <h2 className="text-[16px] font-semibold bg-gradient-to-b from-[#34B23D] to-[#164C1A] bg-clip-text text-transparent">{title}</h2>
...
function PostLinksFooter() {
  return (
    <div className="mt-10 rounded-2xl border border-[#34B23D] bg-gradient-to-t from-[#164C1A]/15 to-[#34B23D]/15 p-6">
      <h2 className="text-[18px] sm:text-[20px] font-semibold bg-gradient-to-b from-[#34B23D] to-[#164C1A] bg-clip-text text-transparent">
        Next steps
      </h2>
    ...
    case "ai-soulmate-drawing-generator":
      return (
        <>
          ...
          <h2 className="text-[20px] sm:text-[24px] font-semibold text-[#1E1E1E]">
            What the tool does
          </h2>
          <p className="text-[#1E1E1E]">
    ...
    case "soulmate-sketch-ai-tips":
      return (
        <>
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>
              <span className="font-medium text-[#1E1E1E]">Pick one style:</span>{" "}
              sketch, realistic, cinematic, or anime—don’t mix.
            </li>
            <li>
              <span className="font-medium text-[#1E1E1E]">Use 1 mood:</span> warm,
            ...
            <li>
              <span className="font-medium text-[#1E1E1E]">Don’t overfit:</span>{" "}
    ...
    case "future-partner-drawing-ai":
      return (
        <>
          ...
          <p className="text-[#1E1E1E]">
            Keep it to: <span className="text-[#1E1E1E]">style</span>{" "}
            (sketch/realistic), <span className="text-[#1E1E1E]">lighting</span>{" "}
            (soft daylight), and <span className="text-[#1E1E1E]">mood</span>{" "}
            (warm/romantic).
          </p>
    ...
    case "best-prompts-for-ai-soulmate-portrait":
      return (
        <>
          ...
          <p className="text-gray-600">Style + Lighting + Mood + 3 Traits</p>
          ...
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
            <div>
              <header className="max-w-none">
                ...
                {Array.isArray(post.tags) && post.tags.length ? (
                  <div className="mt-5 flex flex-wrap gap-2">
                    {post.tags.slice(0, 8).map((t) => (
                      <span
                        key={t}
                        className="rounded-full border border-[#34B23D] bg-zinc-900/70 px-3 py-1 text-xs text-gray-200"
                      >
                        {t}
                      </span>
                    ))}
                ...
                {imageUrl ? (
                  <div className="mt-6 overflow-hidden rounded-2xl border border-[#34B23D]">
                    <img
                      src={imageUrl}
                      alt={post.title}
                      loading="lazy"
              ...
              <section className="mt-8 max-w-none space-y-6 text-[#1E1E1E]">
                {hasDbHtml ? (
