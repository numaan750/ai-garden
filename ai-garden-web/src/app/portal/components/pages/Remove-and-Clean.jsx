  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto scrollbar-hide flex flex-col gap-4 pb-4">
        <Header title="Remove & Clean" onBack={onBack} />
        <StepDots current={0} />
        <div>
...
const AdditionalItemsStep = ({
  ...
  const toggleChip = (obj) => {
    setState((s) => ({
      ...s,
      selectedObjects: s.selectedObjects.includes(obj)
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto scrollbar-hide flex flex-col gap-3 pb-4">
        ...
        {previewImage && (
          <div className="relative rounded-2xl overflow-hidden border-2 border-dashed border-[#B8D4A0] bg-[#164C1A]/30 h-[350px] flex-shrink-0">
            <img
              src={previewImage}
              alt="preview"
              className="w-full h-full object-contain rounded-2xl"
        ...
        <p className="text-[14px] mt-5 mb-5 sm:text-[18px] font-semibold text-[#164C1A]">
          Describe Objects to add and placement
        </p>
