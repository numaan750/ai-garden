...
const Contectus = ({ contact }) => {
  ...
  return (
    <div id="contact" className=" bg-white text-[#1E1E1E] ">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <input
              ...
              className="w-full bg-gradient-to-t from-[#164C1A]/15 to-[#34B23D]/15 text-[#1E1E1E] placeholder-gray-600 rounded-xl px-5 py-4 "
            />
            <input
              type="email"
              name="email"
            ...
            <div className="relative">
              <select
                ...
                onChange={handleChange}
                className="w-full bg-gradient-to-t from-[#164C1A]/15 to-[#34B23D]/15 text-gray-600 rounded-xl px-5 py-4  appearance-none cursor-pointer"
              >
                <option className="bg-[#164C1A]/15 text-[#1E1E1E]" value="">
                  {interestPlaceholder}
                </option>
                <option
                  className="bg-[#164C1A]/15 text-[#1E1E1E]"
                  value="general"
                >
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="5"
              className="w-full bg-gradient-to-t from-[#164C1A]/15 to-[#34B23D]/15 text-[#1E1E1E] placeholder-gray-600 rounded-xl px-5 py-4  resize-none"
            />
            <button
              type="submit"
              disabled={loading}
              className="bg-gradient-to-b from-[#34B23D] to-[#164C1A] rounded-full font-normal px-5 py-3 text-white disabled:opacity-60 sabled:cursor-not-allowed"
            >
          ...
          <div className="md:pl-20 max-w-md py-12 order-1 md:order-2">
            ...
            <p className="text-[#1E1E1E] mb-10 leading-relaxetext-[16px] sm:text-[18px]">
              {contact?.description}
            </p>
            ...
            <div className="space-y-6">
              {contact?.email ? (
                <div className="flex items-start gap-4 md:gap-6">
                  ...
                  <p className="text-[#1E1E1E] text-[16px] sm:text-8px] break-all">
                    {contact.email}
                  </p>
                </div>
              ) : null}
              ...
              {contact?.address ? (
                <div className="flex items-start gap-4 md:gap-6">
                  ...
                  <p className="text-[#1E1E1E] leading-relaxed text16px] sm:text-[18px]">
                    {contact.address}
                  </p>
                </div>
              ) : null}
              ...
              {contact?.phone ? (
                <div className="flex items-start gap-4 md:gap-6">
                  ...
                  <p className="text-[#1E1E1E] text-[16px] sm:text-8px]">
                    {contact.phone}
                  </p>
                </div>
              ) : null}
