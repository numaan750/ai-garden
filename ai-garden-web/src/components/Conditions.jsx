...
const TermsConditions = () => {
  return (
    <div id="terms" className="bg-white text-[#1E1E1E]">
      <div className="mycontainer py-16">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 border-b border-[#34B23D] pb-4 md:pb-6 ">
        ...
        <p className="text-[#1E1E1E] text-base md:text-lg leading-relaxed mt-6">
