...
const AIart = ({ aiArt, country }) => {
  ...
  return (
    <div className="bg-white text-[#1E1E1E] flex flex-col items-center pt-5 pb-10 lg:py-25">
      <div className="mycontainer ">
        <h2 className="text-[24px] sm:text-[30px] md:text-[40px] font-bold mb-2 text-center">
          {aiArt?.title}
        </h2>

        <p className="text-[16px] sm:text-[18px] text-[#1E1E1E] max-w-2xl text-center mb-12 mx-auto">
          {aiArt?.description}
        </p>
              ...
              {aiArt?.img1?.url && (
                <div className="overflow-hidden h-[550px]">
                  <Image
                    ...
                    width={400}
                    height={550}
                    className="w-full h-full object-cover rounded-4xl border border-[#34B23D]"
                  />
                </div>
              )}
              {aiArt?.img2?.url && (
                ...
                {feature?.image && (
                  <div className="overflow-hidden">
                    <Image
                      ...
                      width={500}
                      height={350}
                      className="w-full h-auto object-cover rounded-4xl border border-[#34B23D]"
                    />
                  </div>
                )}
                {feature?.title && (
