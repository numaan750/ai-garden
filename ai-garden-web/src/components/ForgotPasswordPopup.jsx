...
export default function ForgotPasswordPopup({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm px-4">
      <div className="bg-white border border-[#EAEAEA80] rounded-2xl p-6 sm:p-8 max-w-md w-full relative">
        <button
          onClick={handleClose}
        ...
        <h2 className="text-2xl font-bold text-[#3f3a3a] text-center mb-2">
          {step === 1 && "Forgot Password?"}
          {step === 2 && "Enter Verification Code"}
          {step === 3 && "Set New Password"}
        </h2>

        <p className="text-[#3f3a3a] text-center mb-6 text-sm">
        ...
        {step === 1 && (
          <form onSubmit={handleSendCode} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 cursor-pointer bg-gradient-to-b from-[#34B23D] to-[#164C1A] text-white font-semibold rounded-xl "
            >
