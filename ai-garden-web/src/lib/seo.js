...
export const seo = {
  us: {
  title: `AI Garden Landscape Design – Smart Garden Planning & Outdoor Ideas | ${BRAND}`,
  description:
    "Design your perfect outdoor space with AI Garden. Create stunning landscape designs, plan gardens with AI-powered tools, optimize plant placement, and transform your backyard into a beautiful, smart garden in seconds. Try it free.",
},
  uk: {
